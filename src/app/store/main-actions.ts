...
export const GET_FIREBASE_OBJECT_SUCCESS: string =
  "GET_FIREBASE_OBJECT_SUCCESS";
...
export const CREATE_FIREBASE_OBJECT_SUCCESS: string =
  "CREATE_FIREBASE_OBJECT_SUCCESS";
export const CREATE_FIREBASE_OBJECT_FAILED: string =
  "CREATE_FIREBASE_OBJECT_FAILED";

export const DELETE_FIREBASE_OBJECT: string = "DELETE_FIREBASE_OBJECT";
export const DELETE_FIREBASE_OBJECT_SUCCESS: string =
  "DELETE_FIREBASE_OBJECT_SUCCESS";
export const DELETE_FIREBASE_OBJECT_FAILED: string =
  "DELETE_FIREBASE_OBJECT_FAILED";

export const UPDATE_FIREBASE_OBJECT: string = "UPDATE_FIREBASE_OBJECT";
export const UPDATE_FIREBASE_OBJECT_SUCCESS: string =
  "UPDATE_FIREBASE_OBJECT_SUCCESS";
export const UPDATE_FIREBASE_OBJECT_FAILED: string =
  "UPDATE_FIREBASE_OBJECT_FAILED";
...
export const CLEAR_SUCCESS_ACTION: string = "CLEAR_SUCCESS_ACTION";
export class All {
  clearSuccessAction = () => {
    return { type: CLEAR_SUCCESS_ACTION };
  };
  checkAuthAction = () => {
  ...
  deleteFirebaseObject = ({ objectId, objectType }) => {
    return {
      type: DELETE_FIREBASE_OBJECT,
      payload: { objectId, objectType }
    };
  };

  fetchFirebaseArrayAction = (collection: string) => {
    return {
      type: GET_FIREBASE_ARRAY,
      payload: { objectType: collection }
    };
  };
